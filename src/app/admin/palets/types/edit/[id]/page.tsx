...
export default function EditVaryantPage() {
  ...
  const fetchVaryant = async () => {
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          malzeme: data.data.malzeme,
          yuzey: data.data.yuzey,
          agirlik_kg: data.data.agirlik_kg,
          kapasite_kg: data.data.kapasite_kg,
          uyumluluk: data.data.uyumluluk
        });
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Varyant Düzenle</h1>
            <p className="text-gray-600">{varyant.varyant_id}</p>
          </div>
        </div>
      </div>
